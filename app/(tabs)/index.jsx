    ...
    <ScrollView style={styles.background}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.textSection}>
          ...
          {/* Darul Ifta Section */}
          <View style={styles.darulIftaContainer}>
            <Image
              source={require("@/assets/images/ifta_book.png")}
              style={styles.iftaImage}
              resizeMode="cover"
            />
            <Text style={styles.darulIftaTitle}>ফতোয়া বিভাগ</Text>
            <Text style={styles.darulIftaDescription}>
            ...
            <View style={styles.darulIftaLinks}>
              <Link href="/question" style={styles.darulIftaLink}>
                আপনার জিজ্ঞাসা
              </Link>
              <Link href="/fatwas" style={styles.darulIftaLink}>
                ফতোয়া দেখুন
              </Link>
            </View>
          </View>
